...
@Component({
  selector: 'app-casos-asesor-detalle',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './casos-asesor-detaller.html',
  styleUrls: ['./casos-asesor-detaller.css']
})
export class CasosAsesorDetalleComponent implements OnInit {
  casos: Caso[] = [];
  casosFiltrados: Caso[] = [];
  busqueda: string = '';
